...
public:
    ...
    void apply(afw::table::BaseRecord & record, ApFluxComponent const & result) const;
...
public:
    std::vector< boost::shared_ptr<lsst::meas::base::ApFluxComponent> > fluxComponentVector;
...
private:
    ...
    std::vector<ApFluxComponentMapper> _fluxComponentMapperVector;
};
