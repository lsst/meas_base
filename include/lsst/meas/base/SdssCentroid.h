 ...
 *  how to implement new Algorithms.  SdssCentroidAlgorithm is a particularly simple algorithm, while
...
public:
    ...
    /**
     *  This is the type returned by apply().  Because SdssCentroidAlgorithm measure multiple fluxes,
     ...
     *  Exposure being measured.  SdssCentroidAlgorithm only needs a centroid, so we use FootprintCentroidInput.
     */
    ...
    /**
     *  @brief Measure the flux of a source using the SdssCentroid algorithm.
     *
