 ...
 */
double getTestPsfFactor(afwDet::Psf const & psf, afw::geom::Point2D const & center, double shiftmax,
    ...
    // Estimate the TestFlux for the Psf
    ...
    std::pair<double, double> const result = getTestFlux(*psfImage, 0.0, psfXCen, psfYCen, shiftmax,
                                                             maxIter, tol1, tol2);
    return result.first;
}
