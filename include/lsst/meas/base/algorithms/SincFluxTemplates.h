...
#if !defined(LSST_MEAS_BASE_ALGORITHMS_SINCFLUX_TEMPLATES_H)
#define LSST_MEAS_BASE_ALGORITHMS_SINCFLUX_TEMPLATES_H 1
#include <numeric>
#include <cmath>
#include <functional>
#include <map>
...
#include "lsst/meas/base/algorithms/Photometry.h"
