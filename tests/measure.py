...
from lsst.meas.base import MeasurementDataFlags,SingleFrameMeasurementConfig, SingleFrameMeasurementTask
...
class MeasureTestCase(unittest.TestCase):
    ...
    def testFootprintsMeasure(self):
        ...
        task = SingleFrameMeasurementTask(schema, flags, config=measureSourcesConfig)
