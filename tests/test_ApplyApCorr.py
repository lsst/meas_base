...
class ApplyApCorrTestCase(lsst.meas.base.tests.AlgorithmTestCase, lsst.utils.tests.TestCase):
    ...
    def _catalogToAstropy(self, catalog):
        ...
        sourceTable["x"] = sourceTable["slot_Centroid_x"]
        sourceTable["y"] = sourceTable["slot_Centroid_y"]
        del sourceTable["slot_Centroid_x"]
        del sourceTable["slot_Centroid_y"]
        return sourceTable
    ...
    def testSourceTable(self):
        ...
        sourceTable = astropy.table.Table(
            {
                "id": [1],
                "x": [source_test_centroid.x],
                "y": [source_test_centroid.y],
