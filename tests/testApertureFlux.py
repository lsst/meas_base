...
class ApertureFluxTestCase(lsst.utils.tests.TestCase):
    ...
    def testNaive(self):
        ...
        for position in positions:
            for radius in radii:
                ...
                def check(method, image):
                    ...
                    self.assertFalse(result.getFlag("flag_apertureTruncated"))
                    self.assertFalse(result.getFlag("flag_sincCoeffsTruncated"))
        ...
        invalid = ApertureFluxAlgorithm.computeNaiveFlux(
            ...
            self.ctrl)
        self.assertTrue(invalid.getFlag("flag_apertureTruncated"))
        self.assertFalse(invalid.getFlag("flag_sincCoeffsTruncated"))
    ...
    def testSinc(self):
        ...
        invalid1 = ApertureFluxAlgorithm.computeSincFlux(
            ...
            lsst.afw.geom.ellipses.Ellipse(lsst.afw.geom.ellipses.Axes(9.0, 9.0),
                                           lsst.afw.geom.Point2D(25.0, -60.0)),
            self.ctrl)
        self.assertTrue(invalid1.getFlag("flag_apertureTruncated"))
        self.assertTrue(invalid1.getFlag("flag_sincCoeffsTruncated"))
        ...
        invalid2 = ApertureFluxAlgorithm.computeSincFlux(
            ...
            self.ctrl)
        self.assertFalse(invalid2.getFlag("flag_apertureTruncated"))
        self.assertTrue(invalid2.getFlag("flag_sincCoeffsTruncated"))
