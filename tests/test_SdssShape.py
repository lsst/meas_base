    ...
    def testMonteCarlo(self):
        ...
        for noise in (0.0001, 0.001,):
            ...
            for suffix in ["xx", "yy", "xy"]:
                ...
                self.assertFloatsAlmostEqual(shapeStandardDeviation,
                                             np.nanstd(catalog["base_SdssShape_"+suffix]), rtol=0.03)
                self.assertFloatsAlmostEqual(shapeErrMean, shapeStandardDeviation, rtol=0.03)
