...
// xxx #include "lsst/meas/base/algorithms/Measure.h"
// #include "lsst/meas/base/algorithms/CentroidControl.h"
...
// xxx double PsfAttributes::computeGaussianWidth(PsfAttributes::Method how) const {
    /*
...
/* xxx
    ...
    algorithms::GaussianCentroidControl ctrl;
    ...
    algorithms::MeasureSources ms = algorithms::MeasureSourcesBuilder().addAlgorithm(ctrl).build(schema);
