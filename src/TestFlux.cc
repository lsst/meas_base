...
#include "lsst/meas/base/algorithms/TestFluxTemplates.h"
#include "lsst/meas/base/algorithms/all.h"

namespace lsst { namespace meas { namespace base {

template <typename T>
TestFluxAlgorithm::Result TestFluxAlgorithm::apply(
    ...
    //  This code came straight out of the TestFlux.apply() in meas_algorithms with few changes
    ...
    */
         ...
         */
        oldresult = algorithms::getTestFlux<MaskedImageT>(mimage, ctrl.background, xcen, ycen, ctrl.shiftmax, ctrl.maxIter,
                                 ctrl.tol1, ctrl.tol2);
    }
...
/*  Remove the psf scaling for first port -- pgee
    ...
    double psfFactor = algorithms::getTestPsfFactor(*exposure.getPsf(), center, ctrl.shiftmax,
                                    ctrl.maxIter, ctrl.tol1, ctrl.tol2);
    result.fluxCorrectionKeys.psfFactor =  psfFactor;
*/
    //  End of meas_algorithms code
    std::cout << "RETURNING THE RESULT\n";
    return result;
}
...
#define INSTANTIATE(T)                                                  \
    template TestFluxAlgorithm::Result TestFluxAlgorithm::apply(          \
        afw::image::Exposure<T> const & exposure,                       \
