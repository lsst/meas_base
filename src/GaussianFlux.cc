...
GaussianFluxAlgorithm::Result GaussianFluxAlgorithm::apply(
    ...
    if (ctrl.fixed) {
        throw LSST_EXCEPT(pexExceptions::RuntimeErrorException, "fixed option not currently allowed");
    /*
    ...
    */
    ...
    result.floatValue =  oldresult.first;
    result.floatValueSigma = oldresult.second;
