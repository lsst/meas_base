...
PyControl declareControl(lsst::utils::python::WrapperCollection &wrappers) {
...
PyAlgorithm declareAlgorithm(lsst::utils::python::WrapperCollection &wrappers) {
...
PyTransform declareTransform(lsst::utils::python::WrapperCollection &wrappers) {
...
void wrapLocalBackground(lsst::utils::python::WrapperCollection &wrappers) {
