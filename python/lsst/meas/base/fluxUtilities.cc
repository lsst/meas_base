...
using PyFluxResult = py::classh<FluxResult>;
using PyFluxResultKey = py::classh<FluxResultKey>;
using PyMagResult = py::classh<MagResult>;
using PyMagResultKey = py::classh<MagResultKey>;
