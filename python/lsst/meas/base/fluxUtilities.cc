...
void declareFluxResult(lsst::utils::python::WrapperCollection &wrappers) {
...
void declareFluxResultKey(lsst::utils::python::WrapperCollection &wrappers) {
...
void declareMagResult(lsst::utils::python::WrapperCollection &wrappers) {
...
void declareMagResultKey(lsst::utils::python::WrapperCollection &wrappers) {
...
void wrapFluxUtilities(lsst::utils::python::WrapperCollection &wrappers) {
