...
void declareBaseTransform(lsst::utils::python::WrapperCollection &wrappers) {
    wrappers.wrapType(
            py::class_<BaseTransform, std::shared_ptr<BaseTransform>>(wrappers.module,
                                                                      "BaseTransform"),
            [](auto &mod, auto &cls) {
