...
using PyCentroidResult = py::classh<CentroidResult>;
using PyCentroidResultKey = py::classh<CentroidResultKey>;
using PyCentroidTransform = py::classh<CentroidTransform, BaseTransform>;
