...
void declareCentroidResult(lsst::utils::python::WrapperCollection &wrappers) {
...
void declareCentroidResultKey(lsst::utils::python::WrapperCollection &wrappers) {
...
void declareCentroidTransform(lsst::utils::python::WrapperCollection &wrappers) {
...
void declareCentroidChecker(lsst::utils::python::WrapperCollection &wrappers) {
...
void declareUncertaintyEnum(lsst::utils::python::WrapperCollection &wrappers) {
    wrappers.wrapType(
            py::enum_<UncertaintyEnum>(wrappers.module, "UncertaintyEnum"),
            [](auto &mod, auto &enm) {
...
void wrapCentroidUtilities(lsst::utils::python::WrapperCollection &wrappers) {
