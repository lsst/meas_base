...
from .simple_forced_measurement import SimpleForcedMeasurementTask
...
class ForcedPhotDetectorTask(pipeBase.PipelineTask):
    ...
    def run(self, table, exposure, refWcs):
        ...
        outputs.table = self.measurement.finishOutputTable(table, outputs.catalog)
        return outputs
    ...
    def filterRefCat(self, refCatHandles, exposureBBox, exposureWcs):
        ...
        refCat = self.measurement.makeMinimalSourceCatalogFromAstropy(full_table[inBBox])
        return refCat
