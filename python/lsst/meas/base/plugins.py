...
from .transform import ReverseCentroid, TransformWrapper, PassThrough
...
wrapSimpleAlgorithm(SdssCentroidAlgorithm, Control=SdssCentroidControl, executionOrder=0.0, transform=PassThrough)
