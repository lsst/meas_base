...
void declareFlagDefinition(lsst::utils::python::WrapperCollection &wrappers) {
    wrappers.wrapType(
            py::class_<FlagDefinition, std::shared_ptr<FlagDefinition>>(wrappers.module,
                                                                        "FlagDefinition"),
            [](auto &mod, auto &cls) {
                cls.def(py::init<>());
...
void declareFlagDefinitionList(lsst::utils::python::WrapperCollection &wrappers) {
    wrappers.wrapType(
            py::class_<FlagDefinitionList, std::shared_ptr<FlagDefinitionList>>(wrappers.module,
                                                                                "FlagDefinitionList"),
            [](auto &mod, auto &cls) {
                cls.def(py::init<>());
...
void declareFlagHandler(lsst::utils::python::WrapperCollection &wrappers) {
    wrappers.wrapType(
            py::class_<FlagHandler, std::shared_ptr<FlagHandler>>(wrappers.module,
                                                                  "FlagHandler"),
            [](auto &mod, auto &cls) {
                cls.def(py::init<>());
...
void wrapFlagHandler(lsst::utils::python::WrapperCollection &wrappers) {
