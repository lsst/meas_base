...
def makeEmptyExposure(bbox, crval=None, psfSigma=2.0, psfDim=17, fluxMag0=1E12):
    ...
    @param[in]       bbox        Bounding box of the image, in image coordinates, as returned by makeCatalog.
    ...
    @param[in]       psfDim      Width and height of the images returned Gaussian PSF attached to the image
...
def fillImages(catalog, exposure, threshold=None, noise=100.0):
    ...
    for record in catalog:
        ...
        drawGaussian(images[record.getId()], record.get(fluxKey), ellipse)
